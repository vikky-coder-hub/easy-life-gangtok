...
const Auth = () => {
  ...
  const { login, signup, loginWithOTP, sendOTP } = useAuth();
  ...
  const handleSignup = async (e) => {
    ...
    try {
      // Prepare signup data to match backend expectations
      const signupData = {
        name: formData.name,
      ...
      // Add business-specific fields for sellers
      if (formData.userType === 'seller') {
        ...
        // Add category arrays based on business type
        if (formData.businessType === 'product') {
          signupData.productCategories = formData.productCategories || [];
        } else if (formData.businessType === 'service') {
          signupData.serviceCategories = formData.serviceCategories || [];
        }
      }
